...
private _captureSides = _trigger getVariable "grad_extracts_captureSides";
private _owner = _trigger getVariable "grad_extracts_currentOwner";
private _previousOwner = _trigger getVariable "grad_extracts_previousOwner";
private _lockAfterCapture = _trigger getVariable "grad_extracts_lockAfterCapture";
...
if (_lockAfterCapture) then {
    {
        _task = _trigger getVariable (format ["grad_extracts_task_%1",_x]);
