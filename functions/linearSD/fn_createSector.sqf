...
[_logic,_sectorName,0,0,false,[WEST, EAST, INDEPENDENT, CIVILIAN],_owner,_notifyTakingControl,FUNC(onSectorCaptured),_id,[1,_captureTime]] call EFUNC(sectors,createSector);
