...
if (isNull _objective) exitWith {
    [{!isNull _this},{[_this] call FUNC(addObjectiveInteraction)},_objective,10,{ERROR_1("Waiting for objective to be !null timed out: %1",_this)}] call CBA_fnc_waitUntilAndExecute;
};
