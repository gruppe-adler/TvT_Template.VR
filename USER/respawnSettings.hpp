...
bluforWaveLifes = 2;                                                         //Wie oft ein Blufor Spieler respawnen kann
opforWaveLifes = 2;                                                          //Wie oft ein Opfor Spieler respawnen kann
indepWaveLifes = 0;                                                          //Wie oft ein Independent Spieler respawnen kann
